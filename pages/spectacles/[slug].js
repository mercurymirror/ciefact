    ...
    <>
        ...
        <picture>
          {hasImgMob && (
            <source
              ...
              srcSet={spectacle.image_mobile.url}
            />
          )}
          {hasImg && <img src={spectacle.image.url} />}
        </picture>
      ...
      <Container className="spectacle-text">
        <Row className="bloc-mob">
          <Col className="ext a">
            <h1 id="ver-title" className="vertical-title red">
              {spectacle.title}
            </h1>
            <h2 className="quote shows">
              {" "}
              <ReactMarkdown source={spectacle.citation} />
            </h2>
          </Col>
          <Col className="middle-col">
            <p className="">
              <Moment format="YYYY" className="date">
                {spectacle.year}
              </Moment>
            </p>
          ...
          <Col className="ext b">
            ...
            <div className="scroll-down">
              Scroll down
              <img src="/arrow.svg" className="arrow-down" />
            </div>
          </Col>
          {hasIllu && (
            <Col className="illu">
        ...
        <button id="slideLeft" type="button" onClick={slideLeft}>
          <img src="/arrow.svg" className="arrow-down" />
        </button>
        <button id="slideRight" type="button" onClick={slideRight}>
          <img src="/arrow.svg" className="arrow-down" />
        </button>
      </Container>
    </>
